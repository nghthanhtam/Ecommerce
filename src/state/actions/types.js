...
export const GET_MOVIES = 'GET_EMPLOYEES';
export const MOVIES_RECEIVED = 'EMPLOYEES_RECEIVED';
export const UPDATE_MOVIE = 'UPDATE_EMPLOYEE';
export const MOVIE_UPDATED = 'EMPLOYEE_UPDATED';
export const ADD_MOVIE = 'ADD_EMPLOYEE';
export const MOVIE_ADDED = 'EMPLOYEE_ADDED';
export const DELETE_MOVIE = 'DELETE_EMPLOYEE';
export const MOVIE_DELETED = 'EMPLOYEE_DELETED';
