...
class AActiveList extends React.Component {
    state = {
    ...
    componentDidUpdate = (prevProps, prevState, snapshot) => {
        let { isLoaded } = this.props, { end } = this.state
...
AActiveList.propTypes = {
    getProductVars: PropTypes.func.isRequired,
    productVars: PropTypes.array.isRequired,
    isLoaded: PropTypes.bool.isRequired,
};

export default connect(mapStateToProps, { getProductVars, pushHistory })(AActiveList);