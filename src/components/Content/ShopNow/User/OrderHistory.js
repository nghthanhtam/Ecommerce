  ...
  cancel = (item) => {
    ...
    if (item.Purchase.Orders.length > 1) {
      msg =
        ...
        Number(item.Purchase.Orders.length - 1) +
        " đơn hàng khác. Cả " +
    ...
    return (
      <div>
        ...
        >
          ...
          >
            <UserProfile selectedLink="/shopnow/sales/order/history" />

            <div className="orderhis-container">
              <div className="my-order">
                <h2 style={{ color: "#0d1136", marginBottom: "20px" }}>
                  Đơn hàng
                </h2>
                {isLoaded &&
                  orders.map((item, index) => (
                    <>
                      <div
                        ...
                        onClick={() => this.selectOrder(item.id)}
                      >
                              ...
                              <>
                                ...
                                item.status == "delivered" ? (
                                  <>
                                    <div className="status-circle">
                                      {" "}
                                      <i className="status-tick fa fa-check"></i>
                                    </div>
                                    <div className="status-line"></div>
                                  </>
                                ) : (
...
export default connect(mapStateToProps, { getUserOrders, showModal })(
  OrderHistory
);
